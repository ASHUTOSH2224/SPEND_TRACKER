...
export function RuleCreateForm({ categories }: { categories: CategoryRead[] }) {
  ...
  return (
    ...
    >
      <input className="app-input" name="rule_name" placeholder="Rule name" required />
      <input className="app-input" name="match_value" placeholder="SWIGGY" required />
      <select className="app-select" name="assigned_category_id" required defaultValue="">
      ...
      <div className="flex gap-3">
        <select className="app-select" name="match_type" defaultValue="description_contains">
